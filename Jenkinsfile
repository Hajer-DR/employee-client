...
stage('EMPLOYEE-client - Checkout code') {
      steps {
        git url:'https://github.com/Hajer-DR/employee-client.git', branch:'main'
      }
    }
            ...
            steps {
                withAWS(region:'us-east-2',credentials:'aws-creds') {
				  git url:'https://github.com/Narjesse/devOpsaws.git', branch:'main'
                    ...
                    sh 'kubectl delete -f deployment-CLI-POD.yml --namespace=preprod --ignore-not-found=true'
            ...
            steps {
                withAWS(region:'us-east-2',credentials:'aws-creds') {
				  git url:'https://github.com/Narjesse/devOpsaws.git', branch:'main'
                    ...
                    sh 'kubectl delete -f deployment-CLI-POD.yml --namespace=prod --ignore-not-found=true'
